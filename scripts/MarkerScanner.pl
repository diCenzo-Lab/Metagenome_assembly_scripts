...
# HMM search
system ("hmmsearch -Z 486867 -E $evalue --domE $evalue --domtblout $$.hmmsearch -o /dev/null $ref_dir"."markers.hmm $input_seq");		# fix the number of sequences in the database for E-value calculation
get_hmm_hits();
